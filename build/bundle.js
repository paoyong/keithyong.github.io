...
/***/ function(module, exports, __webpack_require__) {
	                    ...
	                    React.createElement("nav", null, 
	                        React.createElement("div", {className: "row", id: "name"}, 
	                            React.createElement(Link, {to: "about"}, 
	                                React.createElement("h1", null, "Keith Yong")
	                            )
	                        ), 
	                        React.createElement("div", {className: "row headerlinks"}, 
	                            React.createElement("ul", {className: "tabs"}, 
	                                React.createElement("li", null, React.createElement(Link, {to: "projects"}, "Projects")), 
	                                React.createElement("li", null, React.createElement(Link, {to: "about"}, "About")), 
	                                React.createElement("li", null, React.createElement("a", {href: "https://github.com/keithyong"}, "GitHub"))
	                            )
	                        )
	                    ), 
	...
	Router.run(routes, function(Handler) {
	    React.render(React.createElement(Handler, null), document.getElementById('react-mount'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Project = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    render: function() {
	        return (
	            React.createElement("a", {className: "row project", href: this.props.link}, 
	                React.createElement("h2", null, this.props.title), 
	                React.createElement("p", {className: "project-description"}, this.props.description), 
	                React.createElement("img", {src: this.props.imgSrc, className: "u-max-full-width", alt: "project-img"})
	            )
	        );
	    }
	});
