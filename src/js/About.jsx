    ...
    render: function() {
        return (
            <div className="row content">
                ...
                <p>For CSS, I went with sass so that I can utilize variables and config files in my stylesheets. I build the css into a minified css file and place that on my index.html.</p>
                <h2>Contacts</h2>
